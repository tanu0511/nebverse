...
const GanttChartModal: React.FC<GanttChartModalProps> = ({ isOpen, setIsOpen, projectName }) => (
    <Modal isOpen={isOpen} setIsOpen={setIsOpen} size="xl">
        ...
        <div className="modal-body" style={{ background: '#f6f8fa', minHeight: 500 }}>
            <div className="d-flex align-items-center mb-2">
                <Button color="primary" isLight className="me-3">
                    + Add Task
                </Button>
                <input type="checkbox" id="hide-completed" className="me-2" />
                <label htmlFor="hide-completed" className="mb-0">Hide completed task</label>
            </div>
