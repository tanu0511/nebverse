                                        ...
                                        <span className="fw-bold">
                                            {proposalData.dealStages === 'Generated' && (
                                                <span className="text-warning">
                                                    <i className="bi bi-dot"></i> Generated
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Qualified' && (
                                                <span className="text-primary">
                                                    <i className="bi bi-dot"></i> Qualified
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Initial Contact' && (
                                                <span className="text-success">
                                                    <i className="bi bi-dot"></i> Initial Contact
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Schedule Appointment' && (
                                                <span className="text-info">
                                                    <i className="bi bi-dot"></i> Schedule Appointment
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Proposal Sent' && (
                                                <span className="text-warning">
                                                    <i className="bi bi-dot"></i> Proposal Sent
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Win' && (
                                                <span className="text-success">
                                                    <i className="bi bi-dot"></i> Win
                                                </span>
                                            )}
                                            {proposalData.dealStages === 'Lost' && (
                                                <span className="text-danger">
                                                    <i className="bi bi-dot"></i> Lost
                                                </span>
                                            )}
                                        </span>
                                    </div>
                        ...
                        <div className="tab-content p-4" style={{ minHeight: 200 }}>
                            <div className="tab-pane fade show active" id="files" role="tabpanel">
                                <div>
                                    ...
                                    >
                                        <i className="bi bi-plus-circle me-2"></i> Upload File
                                    </button>
                                    {uploadedFiles.length === 0 ? (
                                        <div className="text-center mt-5">
                                            <i className="bi bi-file-earmark-excel" style={{ fontSize: 40, color: '#bdbdbd' }}></i>
