...
interface Employee {
  ...
  isSelected?: boolean; // Added property
}
...
const Employees = () => {
  ...
  const [designations, setDesignations] = useState<string[]>([  'Manager','Developer','Designer',]); // State for designations]
    ...
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      ...
      <AddEmployee
        ...
        setIsOpen={(status) => {
          ...
          if (!status) setSelectedEmployee(null);
        }}
        ...
        onAddEmployee={(employee) => {
          const fullEmployee: Employee = {
            ...
            profilePicture: employee.profilePicture instanceof File
              ? URL.createObjectURL(employee.profilePicture)
              : employee.profilePicture,
            hourlyRate: Number(employee.hourlyRate) || 0,
            loginAllowed: true,
            emailNotifications: true,
            skills: employee.skills || '',  // Assign an empty array to match the type
            probationPeriod: ''
          };
          handleAddOrUpdateEmployee(fullEmployee);
        }}
        onAddDepartment={handleAddDepartment} // Pass handleAddDepartment to AddEmployee
      />
      ...
      <ViewEmployeeModal
        ...
        employee={{
          ...
          profilePicture: selectedEmployee?.profilePicture || null,
