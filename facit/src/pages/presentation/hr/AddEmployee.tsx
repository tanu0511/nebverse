...
// Define the Employee interface directly in this file
interface Employee {
  id: number;
  status: string;
  employeeId: string;
  ...
  exitDate?: string; // Add exitDate as an optional property
}
...
const AddEmployee: FC<IAddEmployeeModalProps> = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      onAddEmployee({ id: Date.now(), ...values, hourlyRate: values.hourlyRate.toString() });
      formik.resetForm();
      setIsOpen(false);
    },
  });
