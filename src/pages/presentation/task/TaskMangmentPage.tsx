...
//         setTasks(tasks.filter(task => task.status !== colName));
//     };
...
//     return (
//         <div className="container mt-4 md-5">
//             <SubHeader>
//                 <SubHeaderLeft>
...
//                         </div>
//                         <div>
//                             <Button color="primary" onClick={() => setIsStatusModalOpen(true)}>
//                                 + Add Status Column
//                             </Button>
//                         </div>
//                     </div>
...
//                     const tasksForColumn = tasks.filter(task => {
...
//                                         {tasks.filter((task) => task.status === colName).length}
//                                     </span>
//                                     <Dropdown align="end">
